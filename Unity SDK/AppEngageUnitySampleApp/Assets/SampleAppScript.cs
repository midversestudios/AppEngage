...
public class SampleAppScript: MonoBehaviour
{
	...
	void Start(){
		...
		MidversePlugin.init (app_key); //call once on startup
	...
	void OnApplicationPause(bool pauseStatus) {
		...
		if (!pauseStatus) {
			reward=0;
			MidversePlugin.getPendingRewards ();
